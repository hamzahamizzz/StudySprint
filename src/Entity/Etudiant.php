...
class Etudiant implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'etudiant', targetEntity: Objectif::class, orphanRemoval: true)]
    ...
    public function removeObjectif(Objectif $objectif): static
    {
        if ($this->objectifs->removeElement($objectif)) {
            ...
            if ($objectif->getEtudiant() === $this) {
                $objectif->setEtudiant(null);
            }
        }
